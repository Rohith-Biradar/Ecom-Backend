...
public class ProductController {
    ...
    public ResponseEntity<String> updateProduct(@RequestPart("product") Product product, @RequestPart("imageFile") MultipartFile imageFile) {
        try {
            service.addProduct(product, imageFile); // Assuming addProduct handles both create and update
